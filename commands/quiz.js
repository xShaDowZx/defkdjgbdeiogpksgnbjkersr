...
{ q: "Who created me?", a: ["ThaWither", "Wither", "Fares"] },
...
{ q: "What can be broken, but is never held?", a: ["Promise"] },
{ q: "What is it that lives if it is fed, and dies if you give it a drink?", a: ["Fire"] },
{ q: "What is it that if you have, you want to share me, and if you share, you do not have??", a: ["Secret"] },
{ q: "What can one catch that is not thrown?", a: ["Cold"] },
{ q: "What can one catch that is not thrown?", a: ["Cold"] },
{ q: "What can one catch that is not thrown?", a: ["Cold"] },
{ q: "What can one catch that is not thrown?", a: ["Cold"] },
{ q: "What can one catch that is not thrown?", a: ["Cold"] },
